class AppInterface extends React.Component {
  constructor(props) {
    super(props);
    var colorRange = ["#e31a1c", "#006400", "#D6ED17FF", "#a6cee3", "#c0392b", "#f1c40f", "#16a085", "#3498db", '#e88c5d', '#23a393' ];
  ...
  /* FEATURE IMPORTANCE  */
    ...
    sendImportanceToGraph() {
		...
		console.log(forbiddenEdgesInfo.forbiddenEdges);
		console.log(requiredEdgesInfo.requiredEdges);
		console.log(featureRanks.featureRankToNamesMap);
    ...
    if (selectedFeatureSelection.features != null) {
      ...
      return (
        <div className={'root-div'}>
            ...
            <button className={"sidebar-toggle"} onMouseUp={this.showInfoTrue}><span onClick={this.showInfoTrue} className={"sidebar-icon"}>☰</span></button>
